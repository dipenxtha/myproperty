...
@section('content')
    <div class="card">
        <div class="class-header">
            ...
            <div class="card-body">
                <form action="{{url ('insert-rate')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <div class="col-xs-2">
                        ...
                        <div class="col-xs-2">
                            ...
                            <input type="text" class="form-control" name= "street_no"  required="onsubmit">
                        </div>
                        ...
                        <div class="col-xs-2">
                            ...
                            <input type="number" class="form-control" name= "max_rate"  required="onsubmit">
                        </div>

                        <div class="col-xs-2">
                            <label for="">Distress Value /Rate</label>
                            <input type="number" class="form-control" name= "min_rate"  required="onsubmit">
                        </div>
